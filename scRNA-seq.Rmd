...
# # 📦 LOAD DISEASED (PDAC) Seurat OBJECTS FROM RDS FILES
...
######################################### DONE ####################
####################
# Print final dimensions (genes × cells) of NOR_X
...
#####################################################################
# 3. Plotting — one object at a time (cannot plot a list directly) ─
#####################################################################
